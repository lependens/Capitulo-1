...
# Modelos a comparar (incluyendo ajustados y el nuevo Hargreaves Rs)
models = {
    'PM Estándar': 'ET0_calc',
    'PM Cielo Claro': 'ET0_sun',
    'Hargreaves Ra': 'ET0_harg_ra',
    'Hargreaves Rs': 'ET0_harg_rs',
    'Valiantzas': 'ET0_val',
    'Hargreaves Ra Ajustado': 'ET0_harg_ra_ajustado',
    'Hargreaves Rs Ajustado': 'ET0_harg_rs_ajustado',
